...
public class MainFrame extends JFrame implements ActionListener{
	  Control cpu;
        ...
        JMenuItem firstauthor=new JMenuItem("高健");
        JMenuItem secondauthor=new JMenuItem("马泳博");
        JMenuItem creat = new JMenuItem("创建进程");
        
        JPopupMenu popupMenu=new JPopupMenu();
        JMenuItem run = new JMenuItem("设为运行");
        JMenuItem ready = new JMenuItem("设为就绪");
        JMenuItem wait = new JMenuItem("设为等待");
        JMenuItem finsh=new JMenuItem("终止进程");
        ...
        JButton jbcreate=new JButton("创建进程");//创建进程按钮      
        JButton jbfinsh=new JButton("完成");//完成按钮
                ...
                jtable.addMouseListener(new MouseAdapter(){
                     public void mouseClicked(MouseEvent e) {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            Pcb pcb=cpu.memory.pcb[temp];
                            System.out.println(cpu.memory.pcb[temp].getStatus());
                            if(cpu.memory.pcb[temp].getStatus().equals("运行")){
                                cpu.humility(temp);
                            }
...
//                            run.setEnabled(true);
        ...
        public void actionPerformed (ActionEvent e){
           ...
           if(e.getSource()==finsh){
               ...
               if(cpu.memory.pcb[pid].getStatus().equals("运行")){
                   cpu.retire();
               }

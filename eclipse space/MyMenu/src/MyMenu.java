...
public class MyMenu extends MouseAdapter implements ActionListener{
	...
	private void addmyMenu() {
		...
		mf1.add(new JRadioButton("打开"));
		mf1.add(new JRadioButton("保存"));
		mf1.addSeparator();
		...
		me1.add(new JRadioButton("剪切"));
		me1.add(new JRadioButton("复制"));
	...
	private void addpopupMenu() {
		...
		pm1.add(new JRadioButton("复制"));
		pm1.add(new JRadioButton("粘贴"));
